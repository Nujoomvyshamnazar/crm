...
<div id="wrap" class="layout-7">
  ...
  <div id="content">
    ...
    <!-- Shipping Info -->
    <section class="shipping-info padding-top-20">
      <div class="container">
        <ul>
    ...
    <!-- Tab Section -->
    <section class="padding-top-60 padding-bottom-0">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="filter-links">
              ...
              <h5>Categories</h5>
              <ul>
                <li><a href="#.">Home Audio & Theater <span>(213) </span></a></li>
                <li><a href="#."> TV & Video <span>(38) </span></a></li>
                <li><a href="#."> Camera, Photo & Video <span>(119) </span></a></li>
                <li><a href="#."> Cell Phones & Accessories <span>(28) </span></a></li>
                <li><a href="#."> Headphones<span>(1126) </span></a></li>
                <li><a href="#."> Video Games<span>(84) </span></a></li>
                <li><a href="#."> Bluetooth & Speakers <span>(3323)</span></a></li>
                <li><a href="#."> Gaming Console <span>(732) </span></a></li>
                <li><a href="#."> Computers & Tablets <span>(2134) </span></a></li>
                <li><a href="#."> Monitors <span>(43) </span></a></li>
                <li><a href="#."> Home Appliances<span>(574) </span></a></li>
                <li><a href="#."> Office Supplies<span>(434)</span></a></li>
              </ul>

              <!--  Manufacturers -->
              <h5 class="margin-top-20">Manufacturers</h5>
              <ul>
                <li><a href="#.">Apple <span>(213) </span></a></li>
                <li><a href="#.">Samsung <span>(38) </span></a></li>
                <li><a href="#."> Sharp <span>(119) </span></a></li>
                <li><a href="#.">Electrolux <span>(28) </span></a></li>
                <li><a href="#."> Nokia <span>(1126) </span></a></li>
                <li><a href="#."> LG <span>(84) </span></a></li>
                <li><a href="#."> Panasonic <span>(3323)</span></a></li>
                <li><a href="#."> Dell <span>(732) </span></a></li>
                <li><a href="#."> Lenovo <span>(2134) </span></a></li>
              </ul>

              <!--  Colors -->
              <h5 class="margin-top-20">Colors</h5>
              <ul>
                <li><a href="#.">White <span>(213) </span></a></li>
                <li><a href="#.">Grey <span>(38) </span></a></li>
                <li><a href="#."> Black <span>(119) </span></a></li>
                <li><a href="#.">Red <span>(28) </span></a></li>
                <li><a href="#."> Pink <span>(1126) </span></a></li>
                <li><a href="#."> Pink <span>(84) </span></a></li>
                <li><a href="#."> Orange <span>(3323)</span></a></li>
                <li><a href="#."> Blue <span>(732) </span></a></li>
                <li><a href="#."> Yellow <span>(2134) </span></a></li>
              </ul>
            </div>

            <!-- HOT DEAL -->
            <div class="like-bnr hotdeal-bnr margin-top-50">
              <div class="top-text">
          ...
          <div class="col-md-9">
            ...
            <div class="short-lst">
              <ul>
                <!-- Short List -->
                <li>
                  <p>Showing 1–15 of 756 results</p>
                </li>
                <!-- Short  -->
                <li >
                  <select class="selectpicker">
            ...
            <div class="item-col-3">
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="images/item-img-1-15.jpg" alt="" > <span class="sale-tag">-25%</span>
    ...
    <!-- Shipping Info -->
    <section class="shipping-info bg-colr">
      <div class="container">
        <ul>
